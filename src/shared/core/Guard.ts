...
export class Guard {
    ...
    public static notNan(value: any, argumentName: string) {
        const isNan = isNaN(value)
        if (isNan) {
            return Result.fail<GuardResponse>(`${argumentName} is not number it is NaN.`);
        } else {
            return Result.ok<GuardResponse>()
        }
    }
    ...
    public static isNumber(value: any, argumentName: string) {
        ...
        if (!isNumber) {
            return Result.fail<GuardResponse>(`${argumentName} is not number.`);
        } else {
            return Result.ok<GuardResponse>()
        }
    }
